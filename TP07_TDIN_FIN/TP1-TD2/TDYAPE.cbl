      ...
      *-----------  TABLA-1 SE CARGA EN LA TABLA DINAMICA = TDYNOM --*
       01 TABLA-1.
      ...
      *********** LA TABLA DINAMICA  **********************************
      *****************************************************************
      ***  WMCA = "CODIGO DEL ALUMNO"   *******************************
      ***  WMAN = "APELLIDO Y NOMBRES " *******************************
      *****************************************************************
       01 APYNOM.
          02  WMCA PIC 9(08).
          02  WMAN PIC X(30).
      ...
      *****************************************************************
       ...
       PROCEDURE DIVISION USING APYNOM.
       INICIO.
      *****************************************************************
      *********** CARGA DATOS DE LA TALA EN LA MATRIZ *****************
      *****************************************************************
           DISPLAY "  " ERASE
           CALL   "CARGAPE" USING TABLA-1
           CANCEL "CARGAPE"
           PERFORM RESETEAR.
      *****************************************************************
      ...
      ************************************************************************
       FINX.
            ...
            BLINK
            ACCEPT TECLA
            MOVE "CANCELADO" TO WMAN
            MOVE  00000000   TO WMCA
      ...
      *------  Cancel ----------------------------*
       ...
       EJECUTAR-OPCION.
           ...
           MOVE TMCO1(I3) TO WMCA
           MOVE TMDE1(I3) TO WMAN
           GO FIN.
